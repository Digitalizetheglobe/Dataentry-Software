                    ...
                    <div className=" bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-200">
                        ...
                        {statement && (
                            <div className="mt-6 p-6 bg-gray-50 shadow-lg rounded-xl border border-gray-200">
                                <h2 className="text-2xl font-bold text-blue-600 mb-6 text-center">Bank Statement ( Deposit And Withdrawal )</h2>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="p-4 bg-blue-50 rounded-lg">
                                        <p className="text-sm font-medium text-blue-600">Opening Balance (Last Day Deposit )</p>
