  ...
  const fetchBankStatement = async () => {
    ...
    try {
      const response = await fetch(
        "https://api.cptechsolutions.com/api/bank-statement/generate",
        {
          method: "POST",
          headers: {
              ...
              <div className="mt-6 p-6 bg-gray-50 shadow-lg rounded-xl border border-gray-200">
                ...
                <div className="grid grid-cols-2 mt-4 gap-4">
                  <div className="p-4 bg-blue-50 rounded-lg">
                    ...
                    <p className="text-xl font-bold text-blue-800">
                      {formatCurrency(
                        statement.depositBreakdown.directDeposits
                      )}
                    </p>
                  </div>
                  ...
                  <div className="p-4 bg-red-100 rounded-lg">
                    <p className="text-sm font-medium text-red-600">
                      Dataentry Withdrawal
                    </p>
                    <p className="text-xl font-bold text-red-800">
                      {" "}
                      {formatCurrency(
                        statement.withdrawalBreakdown.directWithdrawals
                      )}
                    </p>
                  </div>
                  <div className="p-4 bg-green-100 rounded-lg">
                    ...
                    <p className="text-xl font-bold text-green-800">
                      {formatCurrency(
                        statement.depositBreakdown.interbankDeposits
                      )}
                    </p>
                  </div>
                  <div className="p-4 bg-red-100 rounded-lg">
                    ...
                    <p className="text-xl font-bold text-red-800">
                      {formatCurrency(
                        statement.withdrawalBreakdown.interbankWithdrawals
                      )}
                    </p>
                  </div>
                  <div className="p-4 bg-purple-100 rounded-lg">
                    ...
                    <p className="text-xl font-bold text-purple-800">
                      {formatCurrency(statement.withdrawalBreakdown.expenses)}
                    </p>
                  </div>
                </div>
              </div>
